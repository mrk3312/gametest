...
typedef enum WeatherCondition {SUNNY, CLOUDY, STORMY, FOGGY, RAINY, DRIZZLY, TOTAL_COUNT} WeatherCondition;
...
extern WeatherCondition randomWeather;
...
//turnstate.c
int GenerateInt(int);
const char* WeatherToString(WeatherCondition);
void EndTurn(void);
